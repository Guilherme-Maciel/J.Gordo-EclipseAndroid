...
public class EnPageJoaoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_en_page_joao);
		
		ImageButton back = (ImageButton) findViewById (R.id.btn_back);
		back.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				
				Intent it = new Intent(EnPageJoaoActivity.this, EnJoaoActivity.class);
				...
				ActivityCompat.startActivity(EnPageJoaoActivity.this, it, activityOptionsCompat.toBundle());
				EnPageJoaoActivity.this.finish();
