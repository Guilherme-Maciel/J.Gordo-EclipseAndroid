...
public class EnPageVeganActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_en_page_vegan);
		
		ImageButton back = (ImageButton) findViewById (R.id.btn_back);
		back.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				
				Intent it = new Intent(EnPageVeganActivity.this, EnVeganActivity.class);
				...
				ActivityCompat.startActivity(EnPageVeganActivity.this, it, activityOptionsCompat.toBundle());
				EnPageVeganActivity.this.finish();
