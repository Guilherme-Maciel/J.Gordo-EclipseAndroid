...
public class PageRatosActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_page_ratos);
		
		ImageButton back = (ImageButton) findViewById (R.id.btn_back);
		back.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				
				Intent it = new Intent(PageRatosActivity.this, RatosActivity.class);
				...
				ActivityCompat.startActivity(PageRatosActivity.this, it, activityOptionsCompat.toBundle());
				PageRatosActivity.this.finish();
