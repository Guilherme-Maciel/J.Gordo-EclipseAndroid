...
public class PageVeganActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_page_vegan);
		
		ImageButton back = (ImageButton) findViewById (R.id.btn_back);
		back.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				
				Intent it = new Intent(PageVeganActivity.this, VeganActivity.class);
				...
				ActivityCompat.startActivity(PageVeganActivity.this, it, activityOptionsCompat.toBundle());
				PageVeganActivity.this.finish();
