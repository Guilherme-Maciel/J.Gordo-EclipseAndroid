...
public class PageJoaoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_page_joao);
		
		ImageButton back = (ImageButton) findViewById (R.id.btn_back);
		back.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				
				Intent it = new Intent(PageJoaoActivity.this, JoaoActivity.class);
				...
				ActivityCompat.startActivity(PageJoaoActivity.this, it, activityOptionsCompat.toBundle());
				PageJoaoActivity.this.finish();
