...
public class EnRatosActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_en_ratos);
		...
		right.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				Intent it = new Intent(EnRatosActivity.this, EnVeganActivity.class);
				...
				ActivityCompat.startActivity(EnRatosActivity.this, it, activityOptionsCompat.toBundle());
				EnRatosActivity.this.finish();
				//startActivity(it);
		}
		});
		...
		left.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				Intent it = new Intent(EnRatosActivity.this, EnJoaoActivity.class);
		...
		acessar.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				...
				Intent it = new Intent(EnRatosActivity.this, EnPageRatosActivity.class);
