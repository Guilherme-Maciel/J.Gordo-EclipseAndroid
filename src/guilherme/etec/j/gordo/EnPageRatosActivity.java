...
public class EnPageRatosActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_en_page_ratos);
		
		ImageButton back = (ImageButton) findViewById (R.id.btn_back);
		back.setOnClickListener (new View.OnClickListener(){
			public void onClick(View arg0){
				
				Intent it = new Intent(EnPageRatosActivity.this, EnRatosActivity.class);
				...
				ActivityCompat.startActivity(EnPageRatosActivity.this, it, activityOptionsCompat.toBundle());
				EnPageRatosActivity.this.finish();
